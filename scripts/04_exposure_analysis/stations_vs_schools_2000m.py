...
OUT_CSV     = DATA_DERIVED / "stations_school_2000m_counts.csv"
...
plt.ylabel("Number of Schools within 2 km")
plt.title("Number of Schools within 2 km of Each Monitoring Station (Berlin)")
plt.tight_layout()

FIG_PATH = DATA_DERIVED / "schools_per_station_2000m.png"
